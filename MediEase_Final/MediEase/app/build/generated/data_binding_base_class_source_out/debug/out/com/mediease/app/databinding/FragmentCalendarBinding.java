...
public final class FragmentCalendarBinding implements ViewBinding {
  ...
  private FragmentCalendarBinding(@NonNull LinearLayout rootView,
      @NonNull CalendarView calendarView, @NonNull RecyclerView rvMedicines,
      @NonNull TextView tvScheduleDate) {
    this.rootView = rootView;
    this.calendarView = calendarView;
    this.rvMedicines = rvMedicines;
    this.tvScheduleDate = tvScheduleDate;
  }
  ...
  public static FragmentCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_schedule_date;
      TextView tvScheduleDate = ViewBindings.findChildViewById(rootView, id);
      if (tvScheduleDate == null) {
        break missingId;
      }

      return new FragmentCalendarBinding((LinearLayout) rootView, calendarView, rvMedicines,
          tvScheduleDate);
    }
